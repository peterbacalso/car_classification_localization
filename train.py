...
from models.basic import SimpleConvNet
...
# =============================================================================
# for image, label, center_x, center_y, width, height in data_pipeline.take(1):
#     print(image.shape[1:])
# =============================================================================
...
simple_cnn = SimpleConvNet(n_classes=n_classes)
